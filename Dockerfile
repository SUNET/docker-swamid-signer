...
RUN apt-get -q update && apt-get -y upgrade && apt-get install -y git wget build-essential libdate-calc-perl libxml2-utils xsltproc opensaml2-tools xmlsec1 autoconf python-pip python-dev libxslt-dev zlib1g-dev
WORKDIR /usr/src
